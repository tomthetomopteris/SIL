...
a6-6-2d-3u-4u-L-a-(3,6-A) (translates to 3,6-anhydro-alpha-L-galactopyranose)
...
If a larger saccharide is represented via repetition of a smaller object, an extra glycosidic linkage must be specified before the repeat flag.
...
SIL also supports uronic acid formatiom via the addition of a -C modifier at the end.
An example is shown below:
